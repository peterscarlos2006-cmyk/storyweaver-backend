...
var NotificationsService = function () {
    ...
    var NotificationsService = _classThis = /** @class */ (function () {
        function NotificationsService_1(prisma, notificationQueue) {
            this.prisma = prisma;
        ...
        NotificationsService_1.prototype.onModuleInit = function () {
            ...
            cron.schedule('* * * * *', function () { return __awaiter(_this, void 0, void 0, function () {
                var dueNotifications, _i, dueNotifications_1, notification;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            dueNotifications = _a.sent();
                            _i = 0, dueNotifications_1 = dueNotifications;
                            _a.label = 2;
                        case 2:
                            if (!(_i < dueNotifications_1.length)) return [3 /*break*/, 5];
                            notification = dueNotifications_1[_i];
                            return [4 /*yield*/, this.notificationQueue.add('send-notification', {
        ...
        NotificationsService_1.prototype.createReminder = function (userId, projectId, schedule) {
