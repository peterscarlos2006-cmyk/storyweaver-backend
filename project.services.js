...
var ProjectsService = function () {
    ...
    var ProjectsService = _classThis = /** @class */ (function () {
        ...
        ProjectsService_1.prototype.create = function (userId, dto) {
            ...
            var startDate = new Date(dto.startDate);
        ...
        ProjectsService_1.prototype.findAllForUser = function (userId) {
            return this.prisma.project.findMany({
                where: { userId: userId },
                orderBy: { createdAt: 'desc' },
            });
        };
        ProjectsService_1.prototype.findOne = function (userId, projectId) {
