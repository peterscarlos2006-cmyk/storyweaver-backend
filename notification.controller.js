...
var CreateReminderDto = function () {
    var _a;
    ...
    var _schedule_extraInitializers = [];
    return _a = /** @class */ (function () {
            function CreateReminderDto() {
                this.projectId = __runInitializers(this, _projectId_initializers, void 0);
                this.schedule = (__runInitializers(this, _projectId_extraInitializers), __runInitializers(this, _schedule_initializers, void 0)); // ISO string
        ...
        (function () {
            ...
            _schedule_decorators = [(0, class_validator_1.IsDateString)()];
            ...
            __esDecorate(null, null, _schedule_decorators, { kind: "field", name: "schedule", static: false, private: false, access: { has: function (obj) { return "schedule" in obj; }, get: function (obj) { return obj.schedule; }, set: function (obj, value) { obj.schedule = value; } }, metadata: _metadata }, _schedule_initializers, _schedule_extraInitializers);
            if (_metadata) Object.defineProperty(_a, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        })(),
        _a;
}();
var NotificationsController = function () {
    var _classDecorators = [(0, common_1.Controller)('users/me/reminders'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
    ...
    var NotificationsController = _classThis = /** @class */ (function () {
        ...
        NotificationsController_1.prototype.create = function (dto, req) {
            return this.notificationsService.createReminder(req.user.userId, dto.projectId, new Date(dto.schedule));
        };
